CREATE OR REPLACE TABLE `self-service-saude.VW_CONS_SAU.TB_EXP_CLASSES_SINISTRO_ALL_ATUAL` AS(
...
CTE_CID AS(
   ...
   SELECT DISTINCT CODIGO,
    DESCRICAO
FROM `self-service-saude.SBX_ESTRATIFICACAO.TB_AUX_ALGORITMO_IDENTIFICACAO_ONCOLOGIA` 
...
--     ON CAST(T1.COD_TPO_ATEND AS NUMERIC) = T5.COD_TIPO_INTERN 
  ...
  LEFT JOIN `self-service-saude.VW_CONS_SAU.DM_MGR_INTERNACAO_DITER` T7
    ...
    ON T1.COD_INTERNACIONAL_DOENCA = T8.CODIGO
