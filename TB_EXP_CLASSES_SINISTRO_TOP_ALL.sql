CREATE OR REPLACE TABLE `self-service-saude.VW_CONS_SAU.TB_EXP_CLASSES_SINISTRO_TOP_ALL` AS
...
--       ,T5.DSC_TIPO_INTERN
  ...
  FROM `self-service-saude.VW_CONS_SAU.DM_MGR_SINISTRO` T1
   INNER JOIN  `self-service-saude.VW_CONS_SAU.TB_EXP_CLASSES_SINISTRO_TOP` TOP
