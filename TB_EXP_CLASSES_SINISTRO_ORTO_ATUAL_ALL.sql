CREATE OR REPLACE TABLE `self-service-saude.VW_CONS_SAU.TB_EXP_CLASSES_SINISTRO_ORTO_ATUAL_ALL` AS(
...
-- where dsc_servico_abrev in ('ARTRODESE COLUNA VIA ANT OU POST LAT TRAT CIRURG',
-- 'ARTRODESE DA COLUNA C INSTRUMENTACAO POR SEGMENTO',
-- 'ARTRODESE TRATAMENTO CIRURGICO',
-- 'COLUNA VERT INFILTRA FORAMINAL FACETARIA ARTICULA',
-- 'CIRURGIA DE COLUNA POR VIA ENDOSCOPICA',
-- 'DENERVACAO PERCUTANEA D FACETA ARTICULAR POR SEG',
...
-- 'LAMINECTOMIA P SEG ARACNOIDITE ABSCESSO EPIDURAL',
-- 'PSEUDARTROSE DE COLUNA TRATAMENTO CIRURGICO',
-- 'RADICULTOMIA',
-- 'SUBSTITUICAO DE CORPO VERTEBRAL',
-- 'TRAT MICROCIRURG CANAL VERTEBRAL ESTREITO POR SEG')
