...
SELECT distinct 
 ...
 TB_02 AS ( 
  ...
  -- DEFINIÇÃO DE DATAS MINIMAS PARA OS SERVICOS QUE FORAM MAPEADOS E SERVICOS ESPECIFICOS QUE ESTÃO MAPEADOS NA TABELA DE SERVICOS.
  TB_03 AS(
...
SELECT 
 COD_ANALITICO_BENEFICIARIO
,MIN(DAT_MIN_QUIMIO) DAT_MIN_QUIMIO
...
SELECT DISTINCT
 A.COD_ANALITICO_BENEFICIARIO
,B.COD_SERVICO
,MIN(DAT_EXECUCAO_SINISTRO) DAT_MIN_QUIMIO
...
WHERE B.COD_SERVICO IN (SELECT COD_SERVICO
                               FROM `sas-saude-alto-custo-hml.SBX_ALTO_CUSTO.TB_COD_SERVICOS` WHERE TIPO_SERV IN ('QUIMIOTERAPIA'))
GROUP BY 1,2) GROUP BY 1)
...
SELECT
 COD_ANALITICO_BENEFICIARIO
,MIN(DAT_MIN_RADIO) DAT_MIN_RADIO
...
SELECT DISTINCT
 A.COD_ANALITICO_BENEFICIARIO
,B.COD_SERVICO
,MIN(DAT_EXECUCAO_SINISTRO) DAT_MIN_RADIO
...
WHERE B.COD_SERVICO IN (SELECT COD_SERVICO
                               FROM `sas-saude-alto-custo-hml.SBX_ALTO_CUSTO.TB_COD_SERVICOS` WHERE TIPO_SERV IN ('RADIOTERAPIA'))
GROUP BY 1,2)GROUP BY 1)

,BIOPSIA AS (
SELECT
 COD_ANALITICO_BENEFICIARIO
,MIN(DAT_MIN_BIOPSIA) DAT_MIN_BIOPSIA
...
SELECT DISTINCT
 A.COD_ANALITICO_BENEFICIARIO
,B.COD_SERVICO
,MIN(DAT_EXECUCAO_SINISTRO) DAT_MIN_BIOPSIA
...
WHERE B.COD_SERVICO IN (SELECT COD_SERVICO
                               FROM `sas-saude-alto-custo-hml.SBX_ALTO_CUSTO.TB_COD_SERVICOS` WHERE TIPO_SERV IN ('BIOPSIA'))
GROUP BY 1,2)GROUP BY 1)
...
SELECT
 COD_ANALITICO_BENEFICIARIO
,MIN(DAT_MIN_PETCT) DAT_MIN_PETCT
...
SELECT DISTINCT
 A.COD_ANALITICO_BENEFICIARIO
,B.COD_SERVICO
,MIN(DAT_EXECUCAO_SINISTRO) DAT_MIN_PETCT
...
WHERE B.COD_SERVICO IN (SELECT COD_SERVICO
                               FROM `sas-saude-alto-custo-hml.SBX_ALTO_CUSTO.TB_COD_SERVICOS` WHERE TIPO_SERV IN ('PET_CT'))
GROUP BY 1,2)GROUP BY 1)
...
LEFT JOIN quimios C
ON A.COD_ANALITICO_BENEFICIARIO = C.COD_ANALITICO_BENEFICIARIO

LEFT JOIN RADIO D
ON A.COD_ANALITICO_BENEFICIARIO = D.COD_ANALITICO_BENEFICIARIO

LEFT JOIN BIOPSIA E
ON A.COD_ANALITICO_BENEFICIARIO = E.COD_ANALITICO_BENEFICIARIO

LEFT JOIN PET_CT F
ON A.COD_ANALITICO_BENEFICIARIO = F.COD_ANALITICO_BENEFICIARIO
)),
