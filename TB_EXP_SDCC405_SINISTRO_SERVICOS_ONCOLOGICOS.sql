 ...
 create or replace table `sas-saude-alto-custo-hml.SBX_ALTO_CUSTO.TB_EXP_SDCC405_SINISTRO_SERVICOS_ONCOLOGICOSV3` AS
...
FROM `sas-saude-alto-custo-hml.SBX_ALTO_CUSTO.TB_WRK0002_SDCC405_SINISTRO_SERVICOS_ONCOLOGICOS` 
...
SELECT distinct 
 ...
 TB_02 AS ( 
  ...
  FROM `sas-saude-alto-custo-hml.SBX_ALTO_CUSTO.TB_WRK0002_SDCC405_SINISTRO_SERVICOS_ONCOLOGICOS` A
  LEFT JOIN TB_01 B
  ON  A.COD_CARTEIRINHA_BENEFICIARIO = B.COD_CARTEIRINHA_BENEFICIARIO
  AND A.DE_PARA = B.DE_PARA
  -- AND B.R_RNK = 1
